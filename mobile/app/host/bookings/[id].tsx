...
import { useBookingById, useApproveBooking, useCancelBooking } from '@/hooks/api-hooks';
        ...
        <View className="px-4 py-6">
          {booking ? (
            <>
              ...
              {/* Actions for requested bookings */}
              {booking.status === 'requested' && (
                <View className="flex-row gap-3 mb-4">
                  <TouchableOpacity
                    className="flex-1 bg-green-500 py-4 rounded-2xl items-center"
                    onPress={handleApprove}
                    disabled={approveBooking.isPending || cancelBooking.isPending}
                  >
