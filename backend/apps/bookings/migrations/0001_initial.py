    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [
                    models.Index(fields=['guest'], name='bookings_bo_guest_i_idx'),
                    models.Index(fields=['rental_property'], name='bookings_bo_rental__idx'),
                    models.Index(fields=['status'], name='bookings_bo_status_idx'),
                    models.Index(fields=['booking_ref'], name='bookings_bo_booking_idx'),
                ],
            },
        ),
    ]
