# StayAfrica Copilot Prompts - Quick Reference

**Purpose:** Copy-paste ready prompts to implement Airbnb feature gaps  
**Date:** January 11, 2026  
**Related:** See AIRBNB_FEATURE_GAP_ANALYSIS.md for detailed gap analysis

---

## How to Use These Prompts

1. **Choose a prompt** from the priority level you want to work on
2. **Copy the entire prompt block** (including context and acceptance criteria)
3. **Paste into your AI coding assistant** (GitHub Copilot Chat, Cursor, Claude, etc.)
4. **Review the generated code** before committing
5. **Test thoroughly** and validate acceptance criteria
6. **Move to next prompt** after completion

---

## 📌 Priority Legend

- **P0 (Critical):** Must-have for competitive baseline - Implement first
- **P1 (High):** Needed for market competitiveness - Implement second
- **P2 (Medium):** Nice to have, competitive advantage - Implement third
- **P3 (Low):** Future enhancements - Implement when ready

---

# P0: Critical Features (Do First)

## P0-1: Flexible Date Search
...
## P0-2: Real-time Messaging WebSockets
...
## P0-5: Dynamic Pricing & Smart Pricing
...
# P1: High Priority Features (Do Second)

## P1-1: AI-Powered Search & Recommendations
...
## P1-3: Shared Wishlists & Trip Planning
...
# P2: Medium Priority Features (Do Third)

## P2-1: Co-hosting Features
...
## P2-3: Split Payments for Groups
...
# P3: Low Priority Features (Do Later)
...
**Total Prompts:** 20 prompts across 4 priority levels

**Estimated Timeline:**
- P0 (5 prompts): 3 weeks
- P1 (7 prompts): 4 weeks
- P2 (5 prompts): 3 weeks
- P3 (3 prompts): 2 weeks

**Total:** ~12 weeks for full implementation

**Next Steps:**
1. Start with P0-1 (Flexible Date Search)
2. Work through P0 prompts sequentially
3. Test thoroughly before moving to P1
...
**Version:** 1.0  
**Maintained by:** StayAfrica Development Team
