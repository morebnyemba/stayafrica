...
export const PropertyCardSkeleton: React.FC = () => (
  <div className="space-y-3 rounded-xl border border-neutral-200 bg-white p-4" role="status" aria-busy="true" aria-label="Loading property">
...
export const BookingPanelSkeleton: React.FC = () => (
  <div className="space-y-4 rounded-xl border border-neutral-200 bg-white p-6" role="status" aria-busy="true" aria-label="Loading booking panel">
