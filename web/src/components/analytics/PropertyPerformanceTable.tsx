    ...
    <div className={`bg-white dark:bg-primary-800/40 rounded-lg shadow-sm border border-sand-200/50 dark:border-primary-700/50 ${className}`}>
      ...
      <div className="px-6 py-4 border-b border-sand-200/50 dark:border-primary-700/50">
        <div className="flex items-center space-x-3">
          <div className="p-2 bg-blue-100 dark:bg-blue-900/30 rounded-lg">
            <Home className="h-5 w-5 text-secondary-600 dark:text-blue-400" />
          </div>
          <div>
            <h3 className="text-lg font-semibold text-primary-900 dark:text-sand-50">Property Performance</h3>
      ...
      <div className="overflow-x-auto">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-primary-500 dark:text-sand-400">
            <Home className="h-12 w-12 mb-3 opacity-50" />
            <p>No properties to display</p>
          </div>
        ) : (
          <table className="w-full">
            <thead className="bg-sand-50 dark:bg-primary-900/50">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-medium text-primary-500 dark:text-sand-400 uppercase tracking-wider">
                  Property
                </th>
                <th
                  className="px-6 py-3 text-left text-xs font-medium text-primary-500 dark:text-sand-400 uppercase tracking-wider cursor-pointer hover:bg-primary-100 dark:hover:bg-primary-800"
            ...
            <tbody className="bg-white dark:bg-primary-800/40 divide-y divide-sand-200/50 dark:divide-primary-700/50">
              {sortedData.map((property) => (
                <tr
                  key={property.property_id}
                  className="hover:bg-sand-50 dark:hover:bg-primary-800/50 transition-colors"
                >
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      {property.property_image ? (
                        ...
                        <div className="h-10 w-10 rounded-lg bg-primary-200 dark:bg-primary-700 flex items-center justify-center mr-3">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="w-16 bg-primary-200 dark:bg-primary-700 rounded-full h-2 mr-2">
                        <div
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-primary-900 dark:text-sand-50">
                    {property.bookings ?? 0}
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
