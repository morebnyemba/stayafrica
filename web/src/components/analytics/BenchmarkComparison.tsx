    ...
    <div className={`bg-white rounded-lg shadow-sm border border-sand-200/50 ${className}`}>
      ...
      <div className="px-6 py-4 border-b border-sand-200/50">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-primary-900">Market Benchmarks</h3>
              ...
              <div key={index} className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-xs text-primary-400">Your Percentile</p>
                    <div className="flex items-center space-x-1">
                      <Award className="h-5 w-5 text-yellow-500" />
                      <span className="text-xl font-bold text-primary-900">
                        {percentile.toFixed(0)}
                      </span>
                      <span className="text-sm text-primary-500">%ile</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative pt-1">
                  ...
                  <div className="overflow-hidden h-3 text-xs flex rounded-full bg-primary-200">
                    <div
