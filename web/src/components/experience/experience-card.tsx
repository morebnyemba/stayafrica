...
export function ExperienceCard({ experience }: ExperienceCardProps) {
  ...
  return (
    <article className="card overflow-hidden hover:shadow-lg transition-shadow duration-200">
      {/* Image */}
      <div className="relative h-48 sm:h-56 bg-primary-200">
        ...
        {experience.category_name && (
          <div className="absolute top-3 left-3">
            <span className="px-3 py-1 bg-white/95 backdrop-blur-sm rounded-full text-xs font-semibold text-primary-900">
              {experience.category_name}
            </span>
          </div>
        )}
      ...
      <div className="p-4 sm:p-6">
        {/* Title and Location */}
        <div className="mb-3">
          <h3 className="text-lg sm:text-xl font-bold text-primary-900 mb-2 line-clamp-2">
            {experience.title}
          </h3>
        ...
        {/* Details */}
        <div className="flex flex-wrap gap-3 mb-4 text-sm text-primary-600">
        ...
        <div className="flex items-center justify-between pt-4 border-t border-primary-200">
          <div>
            <div className="flex items-baseline gap-1">
              ...
              <span className="text-sm text-primary-600">per person</span>
            </div>
          </div>
