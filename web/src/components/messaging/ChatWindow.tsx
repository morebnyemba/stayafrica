...
export const ChatWindow = ({ conversationId, userId, otherUserName }: ChatWindowProps) => {
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-primary-800/40">
      {/* Connection status */}
      {!isConnected && (
      ...
      >
        {allMessages.length === 0 ? (
          <div className="flex items-center justify-center h-full text-primary-400 dark:text-sand-500">
