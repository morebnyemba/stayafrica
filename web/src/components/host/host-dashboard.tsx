        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
          ...
          <div className="dashboard-header mb-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <div className="flex bg-primary-100 rounded-lg p-1 self-start sm:self-auto">
                <button
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 mb-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-3 mt-1.5 text-sm text-yellow-800">
                    ...
                    <Link key={i} href={stat.link} className="stats-card group relative">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-primary-900 mt-1">
                            {stat.value}
                          </p>
                        </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="card-gradient p-5 sm:p-6">
                    <div className="flex items-center justify-between mb-5">
                      ...
                      <Link href="/host/properties" className="text-secondary-600 hover:underline text-sm font-medium flex items-center gap-1">
                    ...
                    {loadingProperties ? (
                      <div className="space-y-3">
                        {[1, 2, 3].map((i) => (
                          <div key={i} className="animate-pulse h-20 bg-primary-200 rounded-xl" />
                        ))}
                      </div>
                        ...
                        {propertiesData.results
                          ...
                          .map((property: any) => {
                            ...
                            return (
                              ...
                              >
                                <div className="w-16 h-16 sm:w-20 sm:h-16 rounded-lg overflow-hidden flex-shrink-0 bg-primary-200">
                                  {img ? (
                                ...
                                <div className="flex-1 min-w-0">
                                  <h3 className="font-semibold text-sm text-primary-900 truncate group-hover:text-secondary-700 transition">
                                    {property.title}
                                  </h3>
                      ...
                      <div className="text-center py-10">
                        ...
                        <h3 className="font-semibold text-primary-900 mb-1">No properties yet</h3>
                        <p className="text-sm text-primary-500 mb-4">Start earning by listing your first property!</p>
                        <Link
                      ...
                      <div className="space-y-2.5">
                        {checkinsData.map((checkin: any) => (
                          <div
                            ...
                            className="flex items-center gap-4 p-3 rounded-xl border border-primary-200"
                          >
              ...
              {performanceData && performanceData.length > 0 && (
                <div className="card-gradient p-5 sm:p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Link href="/host/earnings" className="text-secondary-600 hover:underline text-sm font-medium flex items-center gap-1">
                    ...
                    <table className="w-full min-w-[500px]">
                      <thead>
                        <tr className="border-b border-primary-200">
                          <th className="text-left py-2.5 px-3 text-xs font-semibold uppercase tracking-wider text-primary-500">Property</th>
                          <th className="text-center py-2.5 px-2 text-xs font-semibold uppercase tracking-wider text-primary-500">Bookings</th>
                          <th className="text-center py-2.5 px-2 text-xs font-semibold uppercase tracking-wider text-primary-500">Earnings</th>
                          <th className="text-center py-2.5 px-2 text-xs font-semibold uppercase tracking-wider text-primary-500">Rating</th>
                          <th className="text-center py-2.5 px-2 text-xs font-semibold uppercase tracking-wider text-primary-500">Status</th>
                        </tr>
                      </thead>
                      <tbody>
                        {performanceData.slice(0, 5).map((prop: any) => (
                          <tr key={prop.property_id} className="border-b border-primary-100 hover:bg-sand-50 transition">
                            <td className="py-3 px-3 text-sm text-primary-900 max-w-[180px] truncate font-medium">
                              {prop.property_title}
                            </td>
                            <td className="py-3 px-2 text-center text-sm text-primary-700">
                              {prop.total_bookings ?? 0}
                            </td>
                            <td className="py-3 px-2 text-center text-sm font-semibold text-green-700">
