  ...
  return (
    <div className="bg-white p-4 rounded-lg border border-primary-200">
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <h3 className="font-semibold text-primary-900">{monthName}</h3>
        <button
      ...
      <div className="grid grid-cols-7 gap-1 mb-2">
        {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map((day) => (
          <div key={day} className="text-center text-xs font-semibold text-primary-600">
            {day}
          </div>
        ))}
      </div>
      ...
      {/* Legend */}
      <div className="mt-4 flex items-center justify-between text-xs text-primary-600">
