  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-[1120px] mx-auto px-6 pt-6 pb-12">
        {/* Breadcrumb */}
        {property && (
          <nav className="text-sm text-primary-600 mb-3 flex items-center gap-1.5">
            <Link href="/explore" className="hover:text-primary-900 hover:underline">
              Explore
            </Link>
            <span>›</span>
            {property.country && (
            ...
            <span className="text-primary-900">{property.property_type || 'Property'}</span>
          </nav>
        )}
        {/* Title & Actions Row */}
        <div className="mb-6">
          <h1 className="text-2xl font-semibold text-primary-900 mb-1">
            {property?.title}
          </h1>
          <div className="flex items-center justify-between flex-wrap gap-2">
            <div className="flex items-center gap-2 text-sm">
              {property?.average_rating > 0 && (
                <>
                  ...
                  <button
                    ...
                    className="underline text-primary-900 font-medium hover:text-primary-700"
                  >
              ...
              <span className="flex items-center gap-1 text-primary-900 font-medium">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 rounded-lg hover:bg-sand-100 transition text-sm font-medium text-primary-900 underline"
              >
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 rounded-lg hover:bg-sand-100 transition text-sm font-medium text-primary-900 underline disabled:opacity-50"
              >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-x-12 mt-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center justify-between py-6 border-b border-primary-200">
              <div>
            ...
            {/* Property Highlights */}
            <div className="py-6 border-b border-primary-200 space-y-5">
              {property?.host?.is_verified && (
                <div className="flex items-start gap-4">
                  <UserCheck className="w-6 h-6 text-primary-900 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="font-medium text-primary-900">Verified Host</p>
              ...
              {property?.property_type && (
                <div className="flex items-start gap-4">
                  <Home className="w-6 h-6 text-primary-900 flex-shrink-0 mt-0.5" />
                  <div>
                    <p className="font-medium text-primary-900">Entire {property.property_type.toLowerCase()}</p>
                    <p className="text-sm text-primary-600">
              ...
              {property?.bedrooms && (
                <div className="flex items-start gap-4">
                  <Bed className="w-6 h-6 text-primary-900 flex-shrink-0 mt-0.5" />
                  <div>
            ...
            <div className="py-6 border-b border-primary-200">
              <div className={`relative ${!showFullDescription && isLongDescription ? 'max-h-[120px] overflow-hidden' : ''}`}>
                <p className="text-primary-700 leading-relaxed whitespace-pre-line text-[15px]">
              ...
              {isLongDescription && (
                <button
                  ...
                  className="mt-3 text-primary-900 font-semibold text-sm underline hover:text-primary-700"
                >
            ...
            {/* Reviews Section */}
            <div id="reviews" className="py-6 border-b border-primary-200">
              {reviews && reviews.length > 0 ? (
                <>
                  {/* Rating Summary */}
                  <div className="flex items-center gap-3 mb-6">
                    <Star className="w-6 h-6 fill-primary-900 text-primary-900" />
                    ...
                    {[5, 4, 3, 2, 1].map((star) => {
                      ...
                      return (
                        <div key={star} className="flex items-center gap-2">
                          <span className="text-xs text-primary-900 w-3">{star}</span>
                  ...
                  {reviews.length > 6 && (
                    <button
                      ...
                      className="mt-6 px-6 py-3 border border-primary-900 rounded-lg text-primary-900 font-semibold text-sm hover:bg-sand-50 transition"
                    >
