  ...
  return (
    <div className="bg-sand-100">
      ...
      <section className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-12">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-primary-900 mb-6 sm:mb-8">
      ...
      <section className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        {isLoading ? (
          ...
          <div className="card p-8 sm:p-12 text-center">
            <MapPin className="w-12 sm:w-16 h-12 sm:h-16 text-primary-400 mx-auto mb-4" />
      ...
      <section className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-8 sm:py-16 border-t border-primary-200">
        <div className="mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary-900 mb-2 sm:mb-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 sm:gap-4">
          {[
            ...
            return (
              ...
              >
                <div className="bg-secondary-100 w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center mb-2 sm:mb-3 group-hover:scale-110 transition">
                  <IconComponent className="w-5 h-5 sm:w-6 sm:h-6 text-secondary-600" />
                </div>
                <h3 className="text-sm sm:text-lg font-semibold text-primary-900 group-hover:text-secondary-600 transition">
                  {item.label}
                </h3>
                <p className="text-xs sm:text-sm text-primary-600 mt-1 sm:mt-2 line-clamp-2">
