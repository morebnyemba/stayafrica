  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
        <div className="fixed inset-0 bg-primary-500 bg-opacity-75 transition-opacity" onClick={onClose} />
        
        <div className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
          <div className="absolute right-0 top-0 pr-4 pt-4">
            <button
              type="button"
              className="rounded-md bg-white text-primary-300 hover:text-primary-400"
              onClick={onClose}
            >
              ...
              {step === 'setup' ? (
                ...
                <div>
                  <div className="mb-6">
                    ...
                    <p className="text-xs text-primary-400 text-center mb-4">
                      Or enter this code manually: <code className="bg-primary-100 px-2 py-1 rounded">{secret}</code>
                    </p>
                  </div>

                  <div className="mb-6">
                    <p className="text-sm font-medium text-primary-700 mb-2">Backup Codes</p>
                    <p className="text-xs text-primary-400 mb-2">
                      Save these backup codes in a safe place. You can use them to access your account if you lose your phone.
                    </p>
                    <div className="bg-sand-50 rounded-lg p-3 mb-2">
                  ...
                  <form onSubmit={handleVerifyAndEnable}>
                    ...
                    <input
                      ...
                      placeholder="000000"
                      className="w-full rounded-md border border-primary-300 px-3 py-2 text-center text-2xl tracking-widest mb-4"
                      required
                    />
                    <button
                      type="submit"
