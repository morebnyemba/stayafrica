...
export default function TwoFactorVerify({ email, password, onSuccess, onBack }: TwoFactorVerifyProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-primary-900">Two-Factor Authentication</h2>
      ...
      <form onSubmit={handleVerify} className="space-y-4">
        {useBackupCode ? (
          <div>
            <label htmlFor="backup-code" className="block text-sm font-medium text-primary-700 mb-2">
              Backup Code
            </label>
            <input
              id="backup-code"
              ...
              className="w-full rounded-md border border-primary-300 px-3 py-2"
              required
            />
          </div>
        ) : (
          <div>
            ...
            <input
              ...
              placeholder="000000"
              className="w-full rounded-md border border-primary-300 px-3 py-2 text-center text-2xl tracking-widest"
              required
            />
          </div>
        )}
