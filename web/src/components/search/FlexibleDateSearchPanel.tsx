  ...
  return (
    <div className={`bg-white rounded-xl shadow-lg p-6 ${className}`}>
      <div className="flex items-center gap-2 mb-6">
        ...
        <h3 className="text-lg font-semibold text-primary-900">Date Flexibility</h3>
      </div>

      {/* Flexibility Options */}
      <div className="space-y-3 mb-6">
        <label className="flex items-start gap-3 p-4 border-2 rounded-lg cursor-pointer hover:bg-sand-50 transition">
          <input
            type="radio"
            name="flexibility"
            value="exact"
          ...
          <div className="flex-1">
            <div className="font-medium text-primary-900">Exact dates</div>
        ...
        <label className="flex items-start gap-3 p-4 border-2 rounded-lg cursor-pointer hover:bg-sand-50 transition">
          ...
          />
          <div className="flex-1">
            <div className="font-medium text-primary-900">Flexible days</div>
            <div className="text-sm text-primary-500 mt-1">
            ...
            {flexibility === 'flexible_days' && (
              <div className="mt-3 flex items-center gap-3">
                <button
                  ...
                  className="p-2 rounded-lg bg-primary-100 hover:bg-primary-200 transition"
                >
        ...
        <label className="flex items-start gap-3 p-4 border-2 rounded-lg cursor-pointer hover:bg-sand-50 transition">
          ...
          />
          <div className="flex-1">
            <div className="font-medium text-primary-900">Any weekend</div>
            <div className="text-sm text-primary-500 mt-1">
        ...
        <label className="flex items-start gap-3 p-4 border-2 rounded-lg cursor-pointer hover:bg-sand-50 transition">
          ...
          />
          <div className="flex-1">
            <div className="font-medium text-primary-900">Entire month</div>
            <div className="text-sm text-primary-500 mt-1">
