        ...
        {[1, 2, 3].map((i) => (
          <div key={i} className="bg-white rounded-xl shadow p-6 animate-pulse">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="h-48 bg-primary-200 rounded"></div>
              <div className="h-48 bg-primary-200 rounded"></div>
              <div className="h-48 bg-primary-200 rounded"></div>
            </div>
          </div>
  ...
  if (!results || results.length === 0) {
    return (
      <div className="bg-white rounded-xl shadow p-12 text-center">
        ...
        <p className="text-primary-500">Try adjusting your search criteria or flexibility settings</p>
      </div>
    );
  }
            ...
            <div className="bg-gradient-to-r from-primary-50 to-blue-50 p-6 rounded-t-xl border-b">
              <div className="flex items-center justify-between flex-wrap gap-4">
                ...
                <div className="text-right">
                  <div className="text-sm text-primary-500">Price range</div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {option.sample_properties.slice(0, 3).map((property) => (
                  ...
                  >
                    ...
                    <div>
                      <h5 className="font-semibold text-primary-900 group-hover:text-primary-600 transition line-clamp-1">
                        {property.name}
                      </h5>
