...
export function HeroSection() {
  ...
  return (
    <div className="relative overflow-hidden z-0 bg-gradient-to-br from-primary-900 via-primary-800 to-primary-700 text-sand-50 pt-6 pb-8 sm:pt-12 sm:pb-16 md:pt-16 md:pb-24 lg:pt-20 lg:pb-32">
