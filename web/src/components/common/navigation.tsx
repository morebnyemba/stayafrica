                ...
                <>
                  ...
                  {isHost && (
                    <button
                      ...
                      className="text-sand-200 hover:text-secondary-300 transition font-medium rounded-full px-4 py-2 hover:bg-primary-700/60 flex items-center gap-2"
                    >
                      {switchLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : null}
