      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center">
            ...
            />
            <label htmlFor="applies_to_accommodation" className="ml-2 text-sm text-primary-700">
              Accommodation Fee
            </label>
          </div>
          ...
          <div className="flex items-center">
            <input
              ...
              className="w-4 h-4 text-[#D9B168] border-primary-300 rounded focus:ring-[#D9B168]"
            />
            <label htmlFor="applies_to_cleaning_fee" className="ml-2 text-sm text-primary-700">
              Cleaning Fee
            </label>
          </div>
          ...
          <div className="flex items-center">
            <input
              ...
              className="w-4 h-4 text-[#D9B168] border-primary-300 rounded focus:ring-[#D9B168]"
            />
            <label htmlFor="applies_to_service_fee" className="ml-2 text-sm text-primary-700">
              Service Fee
            </label>
          </div>
        </div>
