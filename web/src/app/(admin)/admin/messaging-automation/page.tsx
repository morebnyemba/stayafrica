...
export default function MessagingAutomation() {
  ...
  const getStatusBadge = (status: string) => {
    ...
    return badges[status] || 'bg-primary-100 text-primary-800';
  };
  ...
  return (
    <div className="p-8">
      ...
      {/* Tabs */}
      <div className="mb-6 border-b border-sand-200/50">
                      ...
                      <tr key={message.id} className="hover:bg-sand-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                            message.is_active ? 'bg-green-100 text-green-800' : 'bg-primary-100 text-primary-800'
                          }`}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                          <div className="flex items-center space-x-2">
                            <button
                              ...
                              className={message.is_active ? 'text-green-600 hover:text-green-900' : 'text-primary-300 hover:text-primary-500'}
                ...
                <table className="min-w-full divide-y divide-primary-200">
                  ...
                  <tbody className="bg-white divide-y divide-primary-200">
                    {quickReplies.map((reply) => (
                      <tr key={reply.id} className="hover:bg-sand-50">
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className="inline-flex items-center px-2.5 py-0.5 rounded text-xs font-mono font-medium bg-primary-100 text-primary-800">
                            {reply.shortcut}
                          </span>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                            reply.is_active ? 'bg-green-100 text-green-800' : 'bg-primary-100 text-primary-800'
                          }`}>
