...
export default function TaxConfigManagement() {
  ...
  const getJurisdictionTypeBadge = (type: string) => {
    ...
    return badges[type] || 'bg-primary-100 text-primary-800';
  };
                ...
                <table className="min-w-full divide-y divide-primary-200">
                  ...
                  <tbody className="bg-white divide-y divide-primary-200">
                    {jurisdictions.map((jurisdiction) => (
                      <tr key={jurisdiction.id} className="hover:bg-sand-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                            jurisdiction.is_active ? 'bg-green-100 text-green-800' : 'bg-primary-100 text-primary-800'
                          }`}>
                  ...
                  <tbody className="bg-white divide-y divide-primary-200">
                    {taxRates.map((rate) => (
                      <tr key={rate.id} className="hover:bg-sand-50">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                            rate.is_active ? 'bg-green-100 text-green-800' : 'bg-primary-100 text-primary-800'
                          }`}>
