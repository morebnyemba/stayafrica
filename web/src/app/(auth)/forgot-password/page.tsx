      ...
      <div className="min-h-screen bg-gradient-to-br from-sand-50 dark:from-primary-900 to-teal-100 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white dark:bg-primary-800/40 rounded-2xl shadow-xl p-8">
          <div className="text-center">
            ...
            <p className="text-primary-500 dark:text-sand-400 mb-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="block w-full pl-10 pr-3 py-3 border border-primary-300 dark:border-primary-600 rounded-xl focus:ring-2 focus:ring-secondary-500 focus:border-transparent bg-sand-50 dark:bg-primary-900"
