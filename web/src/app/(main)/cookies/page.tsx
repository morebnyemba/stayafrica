...
export default function CookiesPage() {
    return (
        <div className="max-w-4xl mx-auto px-4 py-12 md:py-20">
            <h1 className="text-3xl md:text-5xl font-black text-primary-900 mb-6 tracking-tight">
                Cookie Policy
            </h1>
            <p className="text-sm text-primary-500 mb-10">Last updated: {new Date().toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}</p>

            <div className="prose prose-sand max-w-none">
                <section className="mb-8">
                    <h2 className="text-2xl font-bold text-primary-900 mb-4">1. What are Cookies?</h2>
                ...
                <section className="mb-8">
                    <h2 className="text-2xl font-bold text-primary-900 mb-4">2. How We Use Cookies</h2>
                    <p className="text-primary-700 leading-relaxed mb-4">
                        StayAfrica uses cookies for several reasons:
                    </p>
                    <ul className="list-disc pl-5 text-primary-700 space-y-2 mb-4">
                ...
                <section className="mb-8">
                    <h2 className="text-2xl font-bold text-primary-900 mb-4">3. Managing Cookies</h2>
                    <p className="text-primary-700 leading-relaxed mb-4">
                ...
                <section className="mb-8">
                    <h2 className="text-2xl font-bold text-primary-900 mb-4">4. Changes to This Policy</h2>
                    <p className="text-primary-700 leading-relaxed mb-4">
                ...
                <section className="mb-8">
                    ...
                    <p className="text-primary-700 leading-relaxed mb-4">
                        If you have any questions about our use of cookies, please contact us at <a href="mailto:privacy@stayafrica.app" className="text-accent-600 hover:underline">privacy@stayafrica.app</a>.
                    </p>
                </section>
            </div>
        </div>
