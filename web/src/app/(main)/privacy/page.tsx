    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-12 md:py-20">
            ...
            <div className="prose prose-sand max-w-none">
                ...
                <section className="mb-8">
                    <h2 className="text-2xl font-bold text-primary-900 mb-4">3. Sharing of Information</h2>
                    <p className="text-primary-700 leading-relaxed mb-4">
                ...
                <section className="mb-8">
                    ...
                    <p className="text-primary-700 leading-relaxed mb-4">
                        If you have any questions or concerns about this Privacy Policy or our data practices, please contact our Data Protection Officer at <a href="mailto:privacy@stayafrica.app" className="text-accent-600 hover:underline">privacy@stayafrica.app</a>.
                    </p>
                </section>
            </div>
        </div>
