    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-12 md:py-20">
            ...
            <div className="prose prose-sand max-w-none">
                ...
                <section className="mb-8">
                    <h2 className="text-2xl font-bold text-primary-900 mb-4">2. Account Registration</h2>
                    <p className="text-primary-700 leading-relaxed mb-4">
                ...
                <section className="mb-8">
                    <h2 className="text-2xl font-bold text-primary-900 mb-4">3. Booking and Payments</h2>
                    <p className="text-primary-700 leading-relaxed mb-4">
                ...
                <section className="mb-8">
                    <h2 className="text-2xl font-bold text-primary-900 mb-4">4. Host Obligations</h2>
                    <p className="text-primary-700 leading-relaxed mb-4">
                ...
                <section className="mb-8">
                    <h2 className="text-2xl font-bold text-primary-900 mb-4">7. Contact Us</h2>
                    <p className="text-primary-700 leading-relaxed mb-4">
                        If you have any questions about these Terms, please contact us at <a href="mailto:legal@stayafrica.app" className="text-accent-600 hover:underline">legal@stayafrica.app</a>.
                    </p>
                </section>
            </div>
        </div>
