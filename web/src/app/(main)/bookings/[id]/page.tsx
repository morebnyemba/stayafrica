      ...
      <div className="min-h-screen bg-sand-50">
        <div className="max-w-3xl mx-auto px-4 py-8">
          ...
          <button
            ...
            className="flex items-center gap-2 text-primary-600 hover:text-primary-900 mb-6 transition-colors"
          >
          ...
          {isLoading ? (
            <div className="card p-12 text-center">
              ...
              <p className="text-primary-600">Loading booking details...</p>
            </div>
          ) : isError ? (
            <div className="card p-12 text-center">
            ...
            <div className="space-y-6">
              ...
              <div className="card p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    <div className="flex items-center gap-1 text-sm text-primary-500 mb-1">
                ...
                <div className="space-y-3">
                  ...
                  {Number(booking.taxes) > 0 && (
                    <div className="flex justify-between text-primary-700">
                      <span>Taxes</span>
                      <span>
                        {booking.currency} {Number(booking.taxes).toFixed(2)}
                      </span>
                    </div>
                  )}
                  <div className="border-t border-primary-200 pt-3 flex justify-between font-bold text-primary-900 text-lg">
                    <span>Total</span>
                    <span>
              ...
              {(booking.status === 'confirmed' || isCheckedIn || isCheckedOut || booking.status === 'completed') &&
                ...
                <div className="card p-6 border-l-4 border-gold-500">
                  ...
                  {booking.check_in_instructions && (
                    <div className="mb-3">
                      <div className="text-sm text-primary-500 mb-1">Instructions</div>
                      <p className="text-primary-900 whitespace-pre-line">
                        {booking.check_in_instructions}
                      </p>
                    </div>
                  )}
                  {booking.access_code && (
                    <div className="flex items-center gap-3 p-3 bg-primary-50 rounded-lg">
                      ...
                      <div>
                        <div className="text-xs text-primary-500">Access Code</div>
                        <div className="font-mono font-bold text-lg text-primary-900">
                          {booking.access_code}
                        </div>
                      </div>
                    </div>
              ...
              {(canSelfCheckIn || canCheckOut) && (
                <div className="card p-6">
                  ...
                  {actionError && (
                    <div className="flex items-center gap-2 p-3 mb-4 bg-red-50 rounded-lg text-red-700 text-sm">
              ...
              {isCheckedIn && (
                <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-xl border border-blue-200">
                  ...
                  <div>
                    <div className="font-semibold text-blue-800">You&apos;re Checked In!</div>
                    <div className="text-sm text-blue-600">
